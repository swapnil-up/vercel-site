...
<template>
 ...
 Swap's<br>
 <span class="text-coral">musings</span>
 </h1>
 ...
 <div class="space-y-6">
 <div class="border-2 border-ink p-6 rounded-sm">
 <h3 class="font-display font-bold text-lg mb-3">SeriousCLI</h3>
 <ErrorMessageGenerator />
 </div>
 <div class="border-2 border-ink p-6 rounded-sm">
 <h3 class="font-display font-bold text-lg mb-3">Blobby</h3>
 <Tamagotchi />
 </div>
 </div>
 </section>
