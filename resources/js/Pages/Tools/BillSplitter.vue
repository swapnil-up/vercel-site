...
<template>
 ...
 class="p-2 text-coral hover:bg-coral/10 hover:bg-coral/10 rounded-sm transition-colors"
 >
 ...
 <button
 @click="addPerson"
 class="w-full px-3 py-2 bg-sky text-white rounded-sm hover:bg-sky/80 transition-colors flex items-center justify-center text-sm mt-3"
 >
 ...
 class="p-1 text-coral hover:bg-coral/10 hover:bg-coral/10 rounded transition-colors"
 >
 <svg class="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12"/></svg>
 </button>
 </div>
 ...
 <label class="block text-sm font-medium text-warm-muted">
 Shared by
 </label>
 <div class="flex space-x-2">
 <button
 @click="selectAllSharedBy(index)"
 class="px-2 py-1 bg-mint text-white text-xs rounded hover:bg-mint/80 transition-colors"
 >
 All
 </button>
 <button
 @click="clearAllSharedBy(index)"
 class="px-2 py-1 bg-ink dark:bg-[#1C1C1E] text-white text-xs rounded-sm hover:bg-coral transition-colors"
 >
 None
 </button>
 </div>
 ...
 v-for="(person, personIndex) in validPeople"
 :key="personIndex"
 class="flex items-center space-x-2 px-3 py-2 rounded-sm cursor-pointer transition-colors"
 :class="item.sharedBy[personIndex]
 ? 'bg-coral/10 text-coral border border-coral/30'
 : 'bg-cream text-warm-muted hover:bg-coral/10'"
 >
 <input
 ...
 <button
 @click="addItem"
 class="w-full px-3 py-2 bg-mint text-ink rounded-sm hover:bg-mint/80 transition-colors flex items-center justify-center text-sm"
 >
 <svg class="mr-1 h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4"/></svg>
 Add Item
 </button>
 ...
 <button
 @click="addSampleData"
 class="px-4 py-2 bg-sky text-white rounded-sm hover:bg-sky/80 transition-colors text-sm"
 >
 Sample Data
 </button>
 <button
 @click="copyShareLink"
 class="px-4 py-2 bg-ink dark:bg-[#1C1C1E] text-white rounded-sm hover:bg-coral transition-colors text-sm"
 >
 Copy Summary
 </button>
 </div>
